...
//icons
import left from '../../Files/images/left.png';
import close from '../../Files/images/close.png';
    ...
    return(
        <>
            ...
            <div className={styles.btnContainer}>
                ...
                <button className={`${styles.btn} ${styles.backBtn}`} 
                        onClick={handleBackClick}>
                            <img className={styles.lefticon} src={left} alt="left-icon" />
                </button>

                {/* input box to search image in album */}
                {imageList.length !== 0 ?  <input type="text" 
            ...
            <div style={{textAlign:"center"}}>
                ...
                <h1>{imageList.length !== 0 ?"Your Collection":"No Images Found in Your Collection"}</h1>
            </div>
